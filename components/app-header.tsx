...
import { Home, ChevronLeft, Car, LogIn, LogOut } from "lucide-react"
          ...
          <div className="flex items-center space-x-2">
            ...
            {!isExitPage && (
              <Button
                variant="outline"
                size="sm"
                className="flex items-center rounded-xl border-green-200 text-green-700 hover:bg-green-50"
                asChild
              >
            ...
            {showBackButton && !isDashboard && (
              <Button
                variant="outline"
                size="sm"
                className="flex items-center rounded-xl border-gray-200 text-gray-700 hover:bg-gray-50"
                asChild
              >
                <Link href="/">
